...
def main():
    ...
    parser.add_argument("--pose_generator", default="output/checkpoints_bbox_5_G_S/epoch_2499_generator.h5", help="Generator of structure")
    parser.add_argument("--output_img", default='cgan_bbox_5.png', help='Name of the output image')
